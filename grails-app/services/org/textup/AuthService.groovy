...
class AuthService {
    ...
    //             eq("id", cId)
    //             eq("isDeleted", false)
    //             "in"("context.phone", Phones.buildAllPhonesForStaffId(s1.id))
    //         } > 0
    //     }
    //     else { false }
    // }
    ...
    //                 eq("isDeleted", false)
    //             }
    //             "in"("sharedWith", Phones.buildAllPhonesForStaffId(s1.id))
    //             or {
    ...
    //             eq("id", sId)
    //             "in"("phone", Phones.buildAllPhonesForStaffId(s1.id))
    //         } > 0
    //     }
    //     else { false }
    // }
    ...
    //             eq("id", aId)
    //             "in"("owner", Phones.buildAllPhonesForStaffId(s1.id))
    //         } > 0
    //     }
    //     else { false }
    // }
