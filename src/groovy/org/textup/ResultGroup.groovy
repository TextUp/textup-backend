...
class ResultGroup<T> {
    ...
    private final List<Result<T>> successItems = []
    private final List<Result<T>> failureItems = []
    private final Map<ResultStatus,Integer> successStatusToCount = new HashMap<>()
    private final Map<ResultStatus,Integer> failureStatusToCount = new HashMap<>()
